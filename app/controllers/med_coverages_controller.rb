class MedCoveragesController < ApplicationController
  ...
  private
    ...
    def med_coverage_params
      params.require(:med_coverage).permit(:carrier, :plan_level, :plan_type, :network_type, :pcp_fee, :specialist_fee, :er_fee, :rx_brand_fee, :rx_generic_fee, :in_net_deduct_ind, :in_net_deduct_fam, :out_net_deduct_ind, :out_net_deduct_fam, :co_ins_percent, :out_of_pocket_max, :renewal_date)
    end
end
